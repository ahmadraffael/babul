...
export default function Dashboard({ data = [] }: { data: any[] }) {
    ...
    const getPlatformColor = (name: string, idx: number) => {
        ...
        return idx === 0 ? 'bg-primary' : idx === 1 ? 'bg-secondary' : 'bg-shopee';
    };

    const getPlatformIconColor = (name: string, idx: number) => {
        const n = name.toLowerCase();
        if (n === 'shopee') return 'bg-shopee text-white shadow-orange-500/20';
        if (n === 'tokopedia') return 'bg-tokopedia text-white shadow-primary/20';
    ...
    return (
        <>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Omzet Kotor */}
                <div className="bg-surface-container-lowest rounded-xl p-6 flex flex-col gap-4 border border-surface-container-high">
                ...
                <div className="bg-surface-container-lowest rounded-xl p-6 flex flex-col gap-4 border border-surface-container-high">
                    ...
                    <div>
                        ...
                        <div className="mt-2 flex items-center gap-1">
                            <span className="bg-tertiary-fixed text-tertiary text-[10px] font-bold px-1.5 py-0.5 rounded-full">{costPercentage.toFixed(1)}%</span>
                ...
                <div className="bg-surface-container-lowest rounded-xl p-6 flex flex-col gap-4 border border-surface-container-high">
                    ...
                    <div>
                        ...
                        <div className="mt-2 flex items-center gap-1">
                            <span className="bg-primary-fixed text-on-secondary-fixed-variant text-[10px] font-bold px-1.5 py-0.5 rounded-full">{Math.round(avgOrdersPerDay)}</span>
                                ...
                                <div key={idx} className="group relative bg-surface-container-low rounded-2xl p-5 transition-all duration-300 hover:bg-white hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 overflow-hidden cursor-default border border-transparent hover:border-surface-container-high">
                                    ...
                                    <div className="grid grid-cols-3 gap-4 pt-4 mt-4 border-t border-surface-container-high/50 opacity-0 max-h-0 translate-y-4 group-hover:opacity-100 group-hover:max-h-40 group-hover:translate-y-0 transition-all duration-500 ease-in-out pointer-events-none group-hover:pointer-events-auto">
                                        <div className="bg-surface-container-lowest p-3 rounded-lg">
                                            <p className="text-[8px] text-on-surface-variant/60 uppercase font-bold tracking-wider mb-1 flex items-center gap-1">
                                        ...
                                        <div className="bg-surface-container-lowest p-3 rounded-lg">
                                            ...
                                            <p className="font-bold text-sm text-on-surface">Rp {Math.abs(plat.cost).toLocaleString('id-ID')}</p>
                                        </div>
                                        <div className="bg-surface-container-lowest p-3 rounded-lg">
                                            <p className="text-[8px] text-on-surface-variant/60 uppercase font-bold tracking-wider mb-1 flex items-center gap-1">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-surface-container-lowest rounded-xl p-8 flex flex-col border border-surface-container-high">
                ...
                <div className="bg-white rounded-xl p-10 border border-surface-container-high flex flex-col justify-between">
            ...
            <section className="bg-surface-container-lowest rounded-xl p-8 border border-surface-container-high">
